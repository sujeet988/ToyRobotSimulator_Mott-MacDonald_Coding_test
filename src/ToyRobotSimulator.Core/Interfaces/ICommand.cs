...
{
    /// <summary>Represents a command that can be executed by the robot.</summary>
    public interface ICommand
    {
        /// <summary>Executes the command on the given robot within the table context.</summary>
